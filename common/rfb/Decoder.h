...
public:
  ...
  virtual bool readRect(const core::Rect& r, rdr::InStream* is, const ServerParams& server, rdr::OutStream* os) = 0;
  ...
  virtual void getAffectedRegion(const core::Rect& rect, const uint8_t* buffer, size_t buflen,
  ...
  virtual bool doRectsConflict(const core::Rect& rectA, const uint8_t* bufferA, size_t buflenA, const core::Rect& rectB,
                               const uint8_t* bufferB, size_t buflenB, const ServerParams& server);
  ...
  virtual void decodeRect(const core::Rect& r, const uint8_t* buffer, size_t buflen, const ServerParams& server,
