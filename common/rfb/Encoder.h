...
class Encoder {
public:
  Encoder(SConnection* conn, int encoding, enum EncoderFlags flags, unsigned int maxPaletteSize = -1,
  ...
  // efficient short cut.
  virtual void writeSolidRect(int width, int height, const PixelFormat& pf, const uint8_t* colour) = 0;
