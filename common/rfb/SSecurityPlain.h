...
public:
  bool validate(SConnection* sc, const char* username, const char* password, std::string& msg) {
...
protected:
  virtual bool validateInternal(SConnection* sc, const char* username, const char* password, std::string& msg) = 0;
