...
class PixelFormat {
public:
  PixelFormat(int b, int d, bool e, bool t, int rm, int gm, int bm, int rs, int gs, int bs);
  PixelFormat();
  ...
  void bufferFromRGB(uint8_t* dst, const uint8_t* src, int w, int stride, int h) const;
  ...
  void rgbFromBuffer(uint8_t* dst, const uint8_t* src, int w, int stride, int h) const;

  Pixel pixelFromPixel(const PixelFormat& srcPF, Pixel src) const;

  void bufferFromBuffer(uint8_t* dst, const PixelFormat& srcPF, const uint8_t* src, int pixels) const;
  void bufferFromBuffer(uint8_t* dst, const PixelFormat& srcPF, const uint8_t* src, int w, int h, int dstStride,
                        int srcStride) const;
...
private:
  ...
  template <class T>
  void directBufferFromBufferFrom888(T* dst, const PixelFormat& srcPF, const uint8_t* src, int w, int h, int dstStride,
                                     int srcStride) const;
  template <class T>
  void directBufferFromBufferTo888(uint8_t* dst, const PixelFormat& srcPF, const T* src, int w, int h, int dstStride,
                                   int srcStride) const;
...
protected:
  ...
  friend void verifyPixel(const rfb::PixelFormat&, const rfb::PixelFormat&, const uint8_t*);
};
} // namespace rfb
