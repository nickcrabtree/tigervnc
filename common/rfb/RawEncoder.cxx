...
RawEncoder::RawEncoder(SConnection* conn_) : Encoder(conn_, encodingRaw, EncoderPlain) {}
...
void RawEncoder::writeSolidRect(int width, int height, const PixelFormat& pf, const uint8_t* colour) {
  rdr::OutStream* os;
