...
void SMsgWriter::writeCachedRect(const core::Rect& r, const CacheKey& key)
{
...
void SMsgWriter::writeCachedRectInit(const core::Rect& r, const CacheKey& key, int encoding)
{
