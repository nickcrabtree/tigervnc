...
public:
  ...
  virtual void addSocket(network::Socket* sock, bool outgoing = false, AccessRights accessRights = AccessDefault) = 0;
  ...
  virtual void approveConnection(network::Socket* sock, bool accept, const char* reason = nullptr) = 0;
  ...
  virtual void setCursor(int width, int height, const core::Point& hotspot, const uint8_t* cursorData) = 0;
