...
public:
  ...
  Region intersect(const Region& r) const __attribute__((warn_unused_result));
  Region union_(const Region& r) const __attribute__((warn_unused_result));
  Region subtract(const Region& r) const __attribute__((warn_unused_result));
  ...
  bool get_rects(std::vector<Rect>* rects, bool left2right = true, bool topdown = true) const;
