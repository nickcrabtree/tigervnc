...
ExtensionModule vncExt = {vncModuleInit, "VNC", NULL};

static XF86ModuleVersionInfo vncVersRec = {"vnc",
                                           "TigerVNC",
                                           MODINFOSTRING1,
                                           MODINFOSTRING2,
                                           VENDOR_RELEASE,
...
static void* vncSetup(void* module, void* opts, int* errmaj, int* errmin) {
