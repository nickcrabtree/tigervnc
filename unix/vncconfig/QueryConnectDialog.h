...
public:
  ...
  virtual void queryTimedOut() {
    queryRejected();
  };
};

class QueryConnectDialog : public TXDialog,
                           public TXEventHandler,
                           public TXButtonCallback,
                           public core::Timer::Callback {
public:
  QueryConnectDialog(Display* dpy, const char* address_, const char* user_, int timeout_, QueryResultCallback* cb);
