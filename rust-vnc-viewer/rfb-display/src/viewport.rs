...
impl Viewport {
    ...
    pub fn center(&mut self) {
        let center_x = (self.state.framebuffer_width as f64) / 2.0
            - (self.state.window_width as f64) / (2.0 * self.state.pan_zoom.zoom);
        let center_y = (self.state.framebuffer_height as f64) / 2.0
            - (self.state.window_height as f64) / (2.0 * self.state.pan_zoom.zoom);
