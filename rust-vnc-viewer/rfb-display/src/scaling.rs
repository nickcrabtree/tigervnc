...
impl DpiConfig {
    ...
    pub fn new(display_dpi: f64) -> Self {
        ...
        debug!("DPI config: display={:.1}, base={:.1}, scale={:.2}, high_dpi={}", 
...
impl ScaleUtils {
    ...
    pub fn suggest_scale_mode(fb_width: u32, fb_height: u32, window_width: u32, window_height: u32) -> ScaleMode {
        if fb_width == 0 || fb_height == 0 || window_width == 0 || window_height == 0 {
    ...
    pub fn calculate_fit_zoom(fb_width: u32, fb_height: u32, window_width: u32, window_height: u32) -> f64 {
    ...
    pub fn calculate_fill_zoom(fb_width: u32, fb_height: u32, window_width: u32, window_height: u32) -> f64 {
