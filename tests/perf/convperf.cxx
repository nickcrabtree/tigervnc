...
static void testMemcpy(rfb::PixelFormat& dstpf, rfb::PixelFormat& /*srcpf*/, uint8_t* dst, uint8_t* src) {
  int h;
  h = tile;
  while (h--) {
...
static void testBuffer(rfb::PixelFormat& dstpf, rfb::PixelFormat& srcpf, uint8_t* dst, uint8_t* src) {
  dstpf.bufferFromBuffer(dst, srcpf, src, tile, tile, fbsize, fbsize);
}

static void testToRGB(rfb::PixelFormat& /*dstpf*/, rfb::PixelFormat& srcpf, uint8_t* dst, uint8_t* src) {
  srcpf.rgbFromBuffer(dst, src, tile, fbsize, tile);
}

static void testFromRGB(rfb::PixelFormat& dstpf, rfb::PixelFormat& /*srcpf*/, uint8_t* dst, uint8_t* src) {
