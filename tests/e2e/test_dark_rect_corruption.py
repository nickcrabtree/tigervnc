...
Based on the NetWeaver browser resize scenario which has exhibited this corruption. The cached run is the user-visible disk-backed PersistentCache=1 mode; ContentCache=1 is a separate disk-free user feature even though both share the internal PersistentCache-named engine.
"""
