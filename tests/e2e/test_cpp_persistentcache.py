...
def main():
    parser = argparse.ArgumentParser(description="Test C++ viewer PersistentCache functionality")
    ...
    parser.add_argument("--cache-size", type=int, default=256, help="Persistent cache size in MB (default: 256MB)")
    ...
    parser.add_argument("--bandwidth-threshold", type=float, default=10.0, help="Minimum bandwidth reduction percentage (default: 10)")
    ...
    try:
        ...
        server_viewer = VNCServer(args.display_viewer, args.port_viewer, "cpp_pc_viewerwin", artifacts, tracker, geometry="1920x1080", log_level="*:stderr:30", server_choice=server_mode)
        ...
        test_proc = run_cpp_viewer(
            binaries["cpp_viewer"], args.port_content, artifacts, tracker, "cpp_pc_test_viewer", cache_size_mb=args.cache_size, display_for_viewer=args.display_viewer, cache_dir=str(cache_dir)
        )
