...
TEST(ConfigArgs, args) {
  ...
  // Just program name
  argv = {"prog"};
  ret = core::Configuration::handleParamArg(argv.size(), (char**)argv.data(), 0);
  EXPECT_EQ(ret, 0);
  ...
  ret = core::Configuration::handleParamArg(argv.size(), (char**)argv.data(), 2);
  EXPECT_EQ(ret, 0);
  EXPECT_EQ(boolparam, true);
  EXPECT_EQ(intparam, 1);
  EXPECT_STREQ(strparam, "test");
  ...
  ret = core::Configuration::handleParamArg(argv.size(), (char**)argv.data(), 1);
  EXPECT_EQ(ret, 0);
  EXPECT_EQ(boolparam, true);
  EXPECT_EQ(intparam, 1);
  EXPECT_STREQ(strparam, "test");
