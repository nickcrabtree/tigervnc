...
TEST(ArcCache, MissReturnsNull) {
  ArcCache<uint64_t, TestEntry> cache(
      1024, [](const TestEntry& e) { return e.bytes; }, nullptr);
...
TEST(ArcCache, EvictionWhenFull) {
  ArcCache<uint64_t, TestEntry> cache(
      ...
      [](const TestEntry& e) { return e.bytes; }, nullptr);
...
TEST(ArcCache, EvictionCallback) {
  ...
  ArcCache<uint64_t, TestEntry> cache(
      ...
      [](const TestEntry& e) { return e.bytes; }, [&evicted](uint64_t key) { evicted.push_back(key); });
...
TEST(ArcCache, GhostHitAdjustsP) {
  ArcCache<uint64_t, TestEntry> cache(
      100, [](const TestEntry& e) { return e.bytes; }, nullptr);
