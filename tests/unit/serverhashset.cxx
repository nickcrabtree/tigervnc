...
// ============================================================================
// ServerHashSet with uint64_t (cache ID use case)
// ============================================================================
...
TEST(ServerHashSet, VectorKeysRemoveMultiple) {
  ...
  for (int i = 0; i < 10; i++) {
    std::vector<uint8_t> hash = {static_cast<uint8_t>(i), static_cast<uint8_t>(i + 1), static_cast<uint8_t>(i + 2)};
  ...
  // Remove some hashes
  std::vector<std::vector<uint8_t>> toRemove = {hashes[2], hashes[5], hashes[8]};
