...
- [x] `tests/e2e/run_contentcache_test.py`
  - Class: `SEMANTIC_STASH_NOT_IN_HEAD`
  - Stash status: `M`
  - Decision: reject / do not merge
  - Notes: Review 017 showed HEAD unchanged from stash base ignoring whitespace; stash content is stale formatter fallout with broken content-cache test fragments.

- [x] `tests/e2e/run_refresh_stability_test.py`
  - Class: `SEMANTIC_STASH_NOT_IN_HEAD`
  - Stash status: `M`
  - Decision: reject / do not merge
  - Notes: Review 018 showed HEAD unchanged from stash base ignoring whitespace; stash content is stale formatter fallout with broken refresh-stability test fragments.

- [x] `tests/e2e/run_resize_latency_test.py` — Review 019 — reject / do not merge. Notes: HEAD unchanged from stash base ignoring whitespace; stash side is stale formatter fallout with broken resize-latency test fragments.
  - Class: `SEMANTIC_STASH_NOT_IN_HEAD`
  - Stash status: `M`
  - Decision: pending
  - Notes: pending

- [x] `tests/e2e/sandbox_all_tests.py` — Review 020 — reject / do not merge. Notes: HEAD unchanged from stash base ignoring whitespace; stash side is stale formatter fallout with broken sandbox-all-tests fragments.
  - Class: `SEMANTIC_STASH_NOT_IN_HEAD`
  - Stash status: `M`
  - Decision: pending
  - Notes: pending

- [x] `tests/e2e/scenarios.py` — Review 021 — reject / do not merge. Notes: HEAD unchanged from stash base ignoring whitespace; stash side is stale formatter fallout with broken scenarios.py fragments.
  - Class: `SEMANTIC_STASH_NOT_IN_HEAD`
  - Stash status: `M`
  - Decision: pending
  - Notes: pending

- [x] `tests/e2e/scenarios_static.py` — Review 022 — reject / do not merge. Notes: HEAD unchanged from stash base ignoring whitespace; stash side is stale formatter fallout with broken scenarios_static.py fragments.
  - Class: `SEMANTIC_STASH_NOT_IN_HEAD`
  - Stash status: `M`
  - Decision: pending
  - Notes: pending
...
- [x] `tests/e2e/test_cache_parity.py` - Review 024 - reject / do not merge. Notes: HEAD unchanged from stash base ignoring whitespace; stash side is stale formatter fallout with broken test_cache_parity.py fragments.
  - Class: `SEMANTIC_STASH_NOT_IN_HEAD`
  - Stash status: `M`
  - Decision: pending
  - Notes: pending
