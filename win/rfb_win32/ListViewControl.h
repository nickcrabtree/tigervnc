...
public:
  ...
  BOOL InitLVColumns(DWORD idListView, HWND hDlg, int width, int columns, char* title[], DWORD mask, DWORD style,
                     DWORD format);
  BOOL InsertLVItem(DWORD idListView, HWND hDlg, int number, char* texts[], int columns);
  void SetLVItemText(DWORD idListView, HWND hDlg, int numberItem, int namberColumn, char* text);
  void GetLVItemText(DWORD idListView, HWND hDlg, int numberItem, int namberColumn, char* text);
