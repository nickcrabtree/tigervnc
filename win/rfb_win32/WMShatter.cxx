...
bool rfb::win32::IsSafeWM(HWND window, UINT msg, WPARAM wParam, LPARAM lParam) {
  bool result = true;
  switch (msg) {
    // - UNSAFE MESSAGES
  case WM_TIMER:
  ...
  if (!result) {
    vlog.info("IsSafeWM: 0x%p received 0x%x(%I64u, %I64u) - not safe", window, msg, (long long)wParam,
              (long long)lParam);
  }
  return result;
}
