...
bool PasswordDialog::onOk() {
  ...
  if (password1 != password2) {
    MsgBox(nullptr, "The supplied passwords do not match", MB_ICONEXCLAMATION | MB_OK);
    return false;
  }
  if (registryInsecure && (MsgBox(nullptr,
                                  "Please note that your password cannot be stored securely on this system.  "
