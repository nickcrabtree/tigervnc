...
from framework import preflight_check, ArtifactManager, ProcessTracker, VNCServer, check_port_available, check_display_available
    ...
    def run(self):
        ...
        try:
            ...
            while self.running:
                ...
                print("Running periodic cache activity scenario... (Press Ctrl+C to stop)")
                try:
...
def main():
    ...
    parser.add_argument("--display", type=int, default=998, help="Test server display number (default: 998)")
    parser.add_argument("--port", type=int, default=6898, help="Test server port (default: 6898)")
    parser.add_argument("--duration", type=int, default=60, help="Initial scenario duration in seconds (default: 60)")
