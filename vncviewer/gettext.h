...
#define bindtextdomain(Domainname, Dirname) ((void)(Domainname), (void)(Dirname))
#undef bind_textdomain_codeset
#define bind_textdomain_codeset(Domainname, Codeset) ((void)(Domainname), (void)(Codeset))
...
#else
#define pgettext(Msgctxt, Msgid) pgettext_aux(nullptr, Msgctxt GETTEXT_CONTEXT_GLUE Msgid, Msgid, LC_MESSAGES)
#endif
...
#define pgettext_expr(Msgctxt, Msgid) dcpgettext_expr(nullptr, Msgctxt, Msgid, LC_MESSAGES)
