...
protected:
  ...
  void fakeButtonEvent(bool press, int button, const GestureEvent origEvent) override;
  void fakeKeyEvent(bool press, int keycode, const GestureEvent origEvent) override;
