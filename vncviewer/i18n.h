...
extern int fprintf(FILE*, const char*, ...) __attribute__((__format__(__printf__, 2, 3)));
extern int printf(const char*, ...) __attribute__((__format__(__printf__, 1, 2)));
extern int sprintf(char*, const char*, ...) __attribute__((__format__(__printf__, 2, 3)));
extern int snprintf(char*, size_t, const char*, ...) __attribute__((__format__(__printf__, 3, 4)));
