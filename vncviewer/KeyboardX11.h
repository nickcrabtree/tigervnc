...
private:
  void translateToKeySyms(int systemKeyCode, unsigned char group, std::list<uint32_t>* keySyms);
  void translateToKeySyms(int systemKeyCode, unsigned char group, unsigned char mods, std::list<uint32_t>* keySyms);
