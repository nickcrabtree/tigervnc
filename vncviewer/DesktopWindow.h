...
private:
  void addOverlayTip(const char* text, ...) __attribute__((__format__(__printf__, 2, 3)));
  void addOverlayError(const char* text, ...) __attribute__((__format__(__printf__, 2, 3)));
