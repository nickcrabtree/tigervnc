...
MonitorIndicesParameter::MonitorIndicesParameter(const char* name_, const char* desc_, const ListType& v)
...
std::vector<MonitorIndicesParameter::Monitor> MonitorIndicesParameter::fetchMonitors() {
  ...
  for (int i = 0; i < Fl::screen_count(); i++) {
    ...
    Fl::screen_xywh(monitor.x, monitor.y, monitor.w, monitor.h, i);
