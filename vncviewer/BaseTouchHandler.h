...
protected:
  ...
  virtual void fakeButtonEvent(bool press, int button, const GestureEvent origEvent) = 0;
  virtual void fakeKeyEvent(bool press, int keycode, const GestureEvent origEvent) = 0;
